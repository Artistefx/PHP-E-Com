...
<section class="products" id="products">
    ...
    <h1 class="heading"> our <span>Produits</span> </h1>
           ...
           <?php 
                    ...
                    <main>
                     ...
                     <a href='#' class='fas fa-heart'></a>
                        ...
                        <div class='card' style='width: 27 rem;'>
                          <div class='image'>
                          ...
                          <a href='ajouter_panier.php?id=$row[id]' class='btn btn-primary'>Ajouter au panier</a>
                          <a href='produit.php? pdt=$row[id]' class='btn btn-danger'>Voir Plus</a>
