    ...
    <div class="page flex">
      ...
      <li>
        ...
        <div class="content w-full bg-white">
            ...
            <h1 class="p-relative">Catégories</h1>
...
while($row=mysqli_fetch_array($result)){
    ...
    echo "
         <tr>
            <td>$row[id]</td>
             <td>$row[name]</td>
             <td><a href='delete_category.php? id=$row[id]' value='delete'>Supprimer</a></td>
             <td><a href='update_cat.php? id=$row[id]' value='Update'>Modifier</a></td>
